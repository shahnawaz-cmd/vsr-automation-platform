...
const vinPageUrls = [
    'https://vsr.accessautohistory.com/vin-decoder/kawasaki',
    'https://vsr.accessautohistory.com/vin-decoder/suzuki',
    'https://vsr.accessautohistory.com/vin-decoder/cadillac',
    'https://vsr.accessautohistory.com/vin-decoder/freightliner',
    'https://vsr.accessautohistory.com/vin-decoder/volvo',
    'https://vsr.accessautohistory.com/vin-decoder/land-rover',
    'https://vsr.accessautohistory.com/vin-decoder/volkswagen',
    'https://vsr.accessautohistory.com/vin-decoder/subaru',
    'https://vsr.accessautohistory.com/vin-decoder/gmc',
    'https://vsr.accessautohistory.com/vin-decoder/mazda',
    'https://vsr.accessautohistory.com/vin-decoder/lexus',
    'https://vsr.accessautohistory.com/vin-decoder/chevrolet',
    'https://vsr.accessautohistory.com/vin-decoder/kia',
    'https://vsr.accessautohistory.com/vin-decoder/mclaren',
    'https://vsr.accessautohistory.com/vin-decoder/maserati',
    'https://vsr.accessautohistory.com/vin-decoder/porsche',
    'https://vsr.accessautohistory.com/vin-decoder/bmw',
    'https://vsr.accessautohistory.com/vin-decoder/audi',
    'https://vsr.accessautohistory.com/vin-decoder/nissan',
    'https://vsr.accessautohistory.com/vin-decoder/dodge',
    'https://vsr.accessautohistory.com/vin-decoder/hyundai',
    'https://vsr.accessautohistory.com/vin-decoder/jeep',
    'https://vsr.accessautohistory.com/vin-decoder/toyota',
    'https://vsr.accessautohistory.com/vin-decoder/tesla',
    'https://vsr.accessautohistory.com/vin-decoder/honda'
];
...
for (const vinPageUrl of vinPageUrls) {
    test.describe(`VIN Decoder Module - ${vinPageUrl}`, () => {
        for (const viewport of viewports) {
            test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
                ...
                test.beforeEach(async ({ page }) => {
                    targetPage = new VIN_Decoder(page, vinPageUrl);
        ...
        test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
            ...
            const targetPage = new VIN_Decoder(page, vinPageUrl);
            await targetPage.goto();
