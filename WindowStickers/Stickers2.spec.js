  ...
  async goto() { 
    for (let i = 0; i < 3; i++) {
        try {
            ...
            await this.page.waitForLoadState('load'); // Ensure critical resources load
            return;
        } catch (error) {
...
const stickerPageUrls = [
    'https://vsr.accessautohistory.com/window-stickers/rolls-royce',
    'https://vsr.accessautohistory.com/window-stickers/mercedes-benz',
    'https://vsr.accessautohistory.com/window-stickers/subaru',
    'https://vsr.accessautohistory.com/window-stickers/kia',
    'https://vsr.accessautohistory.com/window-stickers/acura',
    'https://vsr.accessautohistory.com/vin-decoder/lexus',
    'https://vsr.accessautohistory.com/window-stickers/gmc',
    'https://vsr.accessautohistory.com/window-stickers/jeep',
    'https://vsr.accessautohistory.com/window-stickers/international',
    'https://vsr.accessautohistory.com/window-stickers/mclaren',
    'https://vsr.accessautohistory.com/window-stickers/alfa-romeo',
    'https://vsr.accessautohistory.com/window-stickers/hummer',
    'https://vsr.accessautohistory.com/window-stickers/mazda',
    'https://vsr.accessautohistory.com/window-stickers/ram',
    'https://vsr.accessautohistory.com/window-stickers/dodge',
    'https://vsr.accessautohistory.com/window-stickers/harley-davidson',
    'https://vsr.accessautohistory.com/window-stickers/genesis',
    'https://vsr.accessautohistory.com/window-stickers/polestar',
    'https://vsr.accessautohistory.com/window-stickers/bugatti',
    'https://vsr.accessautohistory.com/window-stickers/isuzu',
    'https://vsr.accessautohistory.com/window-stickers/volkswagen',
    'https://vsr.accessautohistory.com/window-stickers/volvo',
    'https://vsr.accessautohistory.com/window-stickers/chevrolet',
    'https://vsr.accessautohistory.com/window-stickers/audi',
    'https://vsr.accessautohistory.com/window-stickers/land-rover',
    'https://vsr.accessautohistory.com/window-stickers/maserati',
    'https://vsr.accessautohistory.com/window-stickers/jaguar',
    'https://vsr.accessautohistory.com/window-stickers/lexus',
    'https://vsr.accessautohistory.com/window-stickers/lamborghini',
    'https://vsr.accessautohistory.com/window-stickers/hyundai',
    'https://vsr.accessautohistory.com/window-stickers/nissan',
    'https://vsr.accessautohistory.com/window-stickers/fiat',
    'https://vsr.accessautohistory.com/window-stickers/ford',
    'https://vsr.accessautohistory.com/recall-check/maserati',
    'https://vsr.accessautohistory.com/window-stickers/lincoln',
    'https://vsr.accessautohistory.com/window-stickers/pontiac',
    'https://vsr.accessautohistory.com/window-stickers/saab',
    'https://vsr.accessautohistory.com/window-stickers/buick',
    'https://vsr.accessautohistory.com/window-stickers/honda',
    'https://vsr.accessautohistory.com/window-stickers/bentley',
    'https://vsr.accessautohistory.com/window-stickers/mini',
    'https://vsr.accessautohistory.com/window-stickers/ferrari',
    'https://vsr.accessautohistory.com/window-stickers/aston-martin',
    'https://vsr.accessautohistory.com/window-stickers/infiniti',
    'https://vsr.accessautohistory.com/window-stickers/tesla',
    'https://vsr.accessautohistory.com/window-stickers/mitsubishi',
    'https://vsr.accessautohistory.com/window-stickers/cadillac',
    'https://vsr.accessautohistory.com/window-stickers/toyota',
    'https://vsr.accessautohistory.com/window-stickers/bmw',
    'https://vsr.accessautohistory.com/window-stickers/porsche',
    'https://vsr.accessautohistory.com/window-stickers/chrysler'
];
...
for (const stickerPageUrl of stickerPageUrls) {
    test.describe(`Window Stickers Module - ${stickerPageUrl}`, () => {
        for (const viewport of viewports) {
            test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
                ...
                test.beforeEach(async ({ page }) => {
                    ...
                    targetPage = new Stickers_Page(page, stickerPageUrl);
        ...
        test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
            test.setTimeout(90000);
            const targetPage = new Stickers_Page(page, stickerPageUrl);
            await targetPage.goto();
