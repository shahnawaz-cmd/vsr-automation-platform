...
class Recall_Page {
  ...
  async goto() { await this.page.goto(this.url, { waitUntil: 'load' }); }
...
const recallPageUrls = [
    'https://vsr.accessautohistory.com/recall-check/suzuki',
    'https://vsr.accessautohistory.com/recall-check/tesla',
    'https://vsr.accessautohistory.com/recall-check/toyota',
    'https://vsr.accessautohistory.com/recall-check/subaru',
    'https://vsr.accessautohistory.com/recall-check/smart',
    'https://vsr.accessautohistory.com/recall-check/volvo',
    'https://vsr.accessautohistory.com/recall-check/scion',
    'https://vsr.accessautohistory.com/recall-check/nissan',
    'https://vsr.accessautohistory.com/recall-check/saab',
    'https://vsr.accessautohistory.com/recall-check/pontiac',
    'https://vsr.accessautohistory.com/recall-check/saturn',
    'https://vsr.accessautohistory.com/recall-check/mini',
    'https://vsr.accessautohistory.com/recall-check/lotus',
    'https://vsr.accessautohistory.com/recall-check/mazda',
    'https://vsr.accessautohistory.com/recall-check/gmc',
    'https://vsr.accessautohistory.com/recall-check/kia',
    'https://vsr.accessautohistory.com/recall-check/lexus',
    'https://vsr.accessautohistory.com/recall-check/jaguar',
    'https://vsr.accessautohistory.com/recall-check/lincoln',
    'https://vsr.accessautohistory.com/recall-check/isuzu',
    'https://vsr.accessautohistory.com/recall-check/honda',
    'https://vsr.accessautohistory.com/recall-check/infiniti',
    'https://vsr.accessautohistory.com/recall-check/ford',
    'https://vsr.accessautohistory.com/recall-check/fiat',
    'https://vsr.accessautohistory.com/recall-check/ferrari',
    'https://vsr.accessautohistory.com/recall-check/dodge'
];
...
for (const recallPageUrl of recallPageUrls) {
    test.describe(`Recall Module - ${recallPageUrl}`, () => {
        for (const viewport of viewports) {
            test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
                ...
                test.beforeEach(async ({ page }) => {
                    ...
                    targetPage = new Recall_Page(page, recallPageUrl);
        ...
        test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
            test.setTimeout(90000);
            const targetPage = new Recall_Page(page, recallPageUrl);
            await targetPage.goto();
