...
const recallPageUrls = [
    'https://vsr.accessautohistory.com/recall-check/mclaren',
    'https://vsr.accessautohistory.com/recall-check/aston-martin',
    'https://vsr.accessautohistory.com/recall-check/maserati',
    'https://vsr.accessautohistory.com/recall-check/cadillac',
    'https://vsr.accessautohistory.com/recall-check/plymouth',
    'https://vsr.accessautohistory.com/recall-check/chevrolet',
    'https://vsr.accessautohistory.com/recall-check/mitsubishi',
    'https://vsr.accessautohistory.com/recall-check/hyundai',
    'https://vsr.accessautohistory.com/recall-check/daewoo',
    'https://vsr.accessautohistory.com/recall-check/chrysler',
    'https://vsr.accessautohistory.com/recall-check/lamborghini',
    'https://vsr.accessautohistory.com/recall-check/porsche',
    'https://vsr.accessautohistory.com/recall-check/mercedes-benz',
    'https://vsr.accessautohistory.com/recall-check/oldsmobile',
    'https://vsr.accessautohistory.com/recall-check/alfa-romeo',
    'https://vsr.accessautohistory.com/recall-check/rolls-royce',
    'https://vsr.accessautohistory.com/recall-check/volkswagen',
    'https://vsr.accessautohistory.com/recall-check/land-rover'
];
