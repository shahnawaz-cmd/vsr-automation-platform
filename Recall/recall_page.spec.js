...
const targetUrl = 'https://vsr.accessautohistory.com/recall-check';
const viewports = [
...
test.describe(`Recall Module - ${targetUrl}`, () => {
    for (const viewport of viewports) {
        test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
            ...
            test.beforeEach(async ({ page }) => {
                targetPage = new Recall_Page(page, targetUrl);
    ...
    test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
        ...
        const targetPage = new Recall_Page(page, targetUrl);
        await targetPage.goto();
