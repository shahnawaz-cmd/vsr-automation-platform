...
const classicPageUrls = [
    'https://vsr.accessautohistory.com/classic-window-stickers#arrow',
    'https://vsr.accessautohistory.com/classic-window-stickers#auburn',
    'https://vsr.accessautohistory.com/classic-window-stickers#buick',
    'https://vsr.accessautohistory.com/classic-window-stickers#cadillac',
    'https://vsr.accessautohistory.com/classic-window-stickers#chandler',
    'https://vsr.accessautohistory.com/classic-window-stickers#checker',
    'https://vsr.accessautohistory.com/classic-window-stickers#chevrolet',
    'https://vsr.accessautohistory.com/classic-window-stickers#chrysler',
    'https://vsr.accessautohistory.com/classic-window-stickers#cord',
    'https://vsr.accessautohistory.com/classic-window-stickers#cunningham',
    'https://vsr.accessautohistory.com/classic-window-stickers#davis',
    'https://vsr.accessautohistory.com/classic-window-stickers#desoto',
    'https://vsr.accessautohistory.com/classic-window-stickers#dodge',
    'https://vsr.accessautohistory.com/classic-window-stickers#duesenberg',
    'https://vsr.accessautohistory.com/classic-window-stickers#dupont',
    'https://vsr.accessautohistory.com/classic-window-stickers#durant',
    'https://vsr.accessautohistory.com/classic-window-stickers#elcar',
    'https://vsr.accessautohistory.com/classic-window-stickers#erskine',
    'https://vsr.accessautohistory.com/classic-window-stickers#essex',
    'https://vsr.accessautohistory.com/classic-window-stickers#ford',
    'https://vsr.accessautohistory.com/classic-window-stickers#franklin',
    'https://vsr.accessautohistory.com/classic-window-stickers#gardner',
    'https://vsr.accessautohistory.com/classic-window-stickers#graham',
    'https://vsr.accessautohistory.com/classic-window-stickers#hudson',
    'https://vsr.accessautohistory.com/classic-window-stickers#imperial',
    'https://vsr.accessautohistory.com/classic-window-stickers#jordan',
    'https://vsr.accessautohistory.com/classic-window-stickers#kaiser',
    'https://vsr.accessautohistory.com/classic-window-stickers#kissel',
    'https://vsr.accessautohistory.com/classic-window-stickers#knight',
    'https://vsr.accessautohistory.com/classic-window-stickers#lasalle',
    'https://vsr.accessautohistory.com/classic-window-stickers#lincoln',
    'https://vsr.accessautohistory.com/classic-window-stickers#locomobile',
    'https://vsr.accessautohistory.com/classic-window-stickers#marmon',
    'https://vsr.accessautohistory.com/classic-window-stickers#mercury',
    'https://vsr.accessautohistory.com/classic-window-stickers#moon',
    'https://vsr.accessautohistory.com/classic-window-stickers#mustang',
    'https://vsr.accessautohistory.com/classic-window-stickers#nash',
    'https://vsr.accessautohistory.com/classic-window-stickers#oakland',
    'https://vsr.accessautohistory.com/classic-window-stickers#oldsmobile',
    'https://vsr.accessautohistory.com/classic-window-stickers#overland',
    'https://vsr.accessautohistory.com/classic-window-stickers#packard',
    'https://vsr.accessautohistory.com/classic-window-stickers#paige',
    'https://vsr.accessautohistory.com/classic-window-stickers#peerless',
    'https://vsr.accessautohistory.com/classic-window-stickers#plymouth',
    'https://vsr.accessautohistory.com/classic-window-stickers#pontiac',
    'https://vsr.accessautohistory.com/classic-window-stickers#reo',
    'https://vsr.accessautohistory.com/classic-window-stickers#roamer',
    'https://vsr.accessautohistory.com/classic-window-stickers#rolls-royce',
    'https://vsr.accessautohistory.com/classic-window-stickers#stearns',
    'https://vsr.accessautohistory.com/classic-window-stickers#studebaker'
];
...
for (const classicPageUrl of classicPageUrls) {
    test.describe(`Classic Stickers Module - ${classicPageUrl}`, () => {
        for (const viewport of viewports) {
            test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
                ...
                test.beforeEach(async ({ page }) => {
                    ...
                    targetPage = new Classic_Stickers_Page(page, classicPageUrl);
        ...
        test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
            test.setTimeout(90000);
            const targetPage = new Classic_Stickers_Page(page, classicPageUrl);
            await targetPage.goto();
