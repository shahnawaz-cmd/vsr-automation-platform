...
const targetUrl = 'https://vsr.accessautohistory.com/license-plate';
const viewports = [
...
test.describe(`License Plate Module - ${targetUrl}`, () => {
    for (const viewport of viewports) {
        test.describe(`Viewport: ${viewport.width}x${viewport.height}`, () => {
            ...
            test.beforeEach(async ({ page }) => {
                targetPage = new License_Plate(page, targetUrl);
    ...
    test('One-Time: Meta, Heading, Link Integrity, and CTA Report', async ({ page }, testInfo) => {
        ...
        const targetPage = new License_Plate(page, targetUrl);
        await targetPage.goto();
